      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl">
          <div className="mb-6 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">Masuk ke akun Anda untuk mulai mengelola</p>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full mt-2 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-slate-950 text-sm font-semibold py-2.5 rounded-lg transition-colors flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isPending ? (
