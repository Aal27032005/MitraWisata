...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col bg-slate-50 text-slate-900 overflow-hidden font-sans dark:bg-slate-950 dark:text-slate-100">
      ...
      <main className="flex-grow z-10">
        <section className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-950 max-w-4xl mx-auto leading-[1.15] dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto bg-white hover:bg-slate-100 border border-slate-200 text-slate-800 text-base font-semibold px-8 py-3.5 rounded-xl transition-colors flex items-center justify-center dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-slate-800 dark:text-slate-200"
            >
              Masuk ke Dashboard
            </Link>
          </div>
        ...
        {/* Roles Section */}
        <section className="py-16 border-t border-slate-200 bg-white/40 dark:border-slate-900 dark:bg-slate-950/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center space-y-2">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 tracking-tight dark:text-white">Satu Platform, Tiga Solusi Terintegrasi</h2>
              <p className="text-slate-600 text-sm max-w-xl mx-auto dark:text-slate-400">Dirancang untuk menghubungkan pengelola destinasi, pemandu wisata profesional, dan wisatawan.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1: Mitra Wisata */}
              <div className="bg-white/80 backdrop-blur-xl border border-slate-200 hover:border-emerald-500/20 rounded-2xl p-6 transition-all duration-300 group dark:bg-slate-900/40 dark:border-slate-900">
                ...
                <h3 className="text-lg font-bold text-slate-950 mb-2 dark:text-white">Mitra Destinasi Wisata</h3>
              ...
              <div className="bg-white/80 backdrop-blur-xl border border-slate-200 hover:border-emerald-500/20 rounded-2xl p-6 transition-all duration-300 group dark:bg-slate-900/40 dark:border-slate-900">
                ...
                <h3 className="text-lg font-bold text-slate-950 mb-2 dark:text-white">Pemandu Wisata / Guide</h3>
                <p className="text-slate-600 text-sm leading-relaxed dark:text-slate-400">
              ...
              <div className="bg-white/80 backdrop-blur-xl border border-slate-200 hover:border-emerald-500/20 rounded-2xl p-6 transition-all duration-300 group dark:bg-slate-900/40 dark:border-slate-900">
                ...
                <h3 className="text-lg font-bold text-slate-950 mb-2 dark:text-white">Wisatawan / Customer</h3>
                <p className="text-slate-600 text-sm leading-relaxed dark:text-slate-400">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 bg-white py-8 z-10 dark:border-slate-900 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <Compass className="w-5 h-5 text-emerald-400" />
            <span className="text-sm font-semibold text-slate-600 dark:text-slate-400">&copy; {new Date().getFullYear()} MitraWisata Platform. All rights reserved.</span>
          </div>
          <div className="flex gap-6 text-sm text-slate-500">
            <a href="#" className="hover:text-slate-700 dark:hover:text-slate-400">Terms</a>
            <a href="#" className="hover:text-slate-700 dark:hover:text-slate-400">Privacy</a>
            <a href="#" className="hover:text-slate-700 dark:hover:text-slate-400">Contact</a>
          </div>
        </div>
      </footer>
    </div>
